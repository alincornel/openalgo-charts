...
The base engine is **93.60 kB Brotli**; all nine tiers total **247.32 kB Brotli**,
measured with `size-limit` on the 2.5.1 build. Optional tiers are separate imports.
