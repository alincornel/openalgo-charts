...
package (every tier) is about **118 KB Brotli**, the base engine alone is **59 KB**, and it
...
| `openalgo-charts/indicators` | 91 built-in indicators (SMA/EMA/MACD/Bollinger/RSI/ADX/VWAP/Supertrend/HalfTrend/CPR/...) + the Tier-2 contract |
