...
package (every tier) is about **74 KB Brotli** — the base engine alone is **37 KB** — and
...
| `openalgo-charts/indicators` | 20 built-in indicators (SMA/EMA/MACD/Bollinger/RSI/ADX/HalfTrend/...) + the Tier-2 contract |
