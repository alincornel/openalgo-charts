...
The Axes tab's **Navigation** group exposes two fields through the same schema and
settings persistence as the other controls:

| Key | Control | Default |
|---|---|---|
| `navigation.mousePan` | Select **Mouse drag**: **Horizontal only** (`'horizontal'`) or **Time and price** (`'both'`) | `'horizontal'` |
