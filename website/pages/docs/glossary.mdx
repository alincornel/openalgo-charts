...
touch or `navigation.mousePan: 'both'`. Mouse panning is horizontal by default
and preserves auto scale. The visible price range is fixed until auto scale is restored. Programmatically
