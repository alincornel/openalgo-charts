...
return chart;`} caption="Position + resting order + TP/SL brackets + buy/sell fill markers — segmented pills, all draggable/cancelable with hover states and a drag ghost." />
