...
loadable tier (**36.01 KB** Brotli), and it is the only one that builds DOM.
...
`navigation: { mousePan: 'horizontal', defaultVisibleBars: 100 }` to show the
...
0 fits all loaded bars. Mouse and pen panning is horizontal by default.
...
|---|---|--:|--:|
| Widget tier | `openalgo-charts.widget.mjs` | 37 KB | 36.01 KB |
