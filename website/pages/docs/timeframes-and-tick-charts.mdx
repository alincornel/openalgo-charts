...
**weeks** - because the time axis is a logical index, not a fixed grid.
...
both drive the time-axis ticks and the crosshair pill. See [Timezones](/docs/timezones).
...
[Reading a code back](/docs/custom-intervals#reading-a-code-back).
