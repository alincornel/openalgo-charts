...
// Falls back to IST calendar days when sessions are unreadable.
function sessionStartFlags(times: readonly number[]): boolean[]
...
should use these rather than `isNewIstDay`.
