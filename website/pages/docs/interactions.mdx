...
- **Drag the plot**: mouse and pen pan time horizontally by default. Set
  `navigation.mousePan: 'both'` to also pan price vertically.
...
Horizontal mouse and pen panning leaves the price scale's autoscale setting in place. The
