...
- **Wheel**: zoom both axes around the cursor. `wheelZoomSensitivity` defaults
  to `1`; lower values tame high-frequency trackpad bursts and `0` disables
  wheel zoom without changing pinch or keyboard zoom.
