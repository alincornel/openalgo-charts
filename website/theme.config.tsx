...
const config = {
  ...
  footer: {
    content: (
      <div style={{ display: 'flex', flexDirection: 'column', gap: 4, fontSize: '0.85rem' }}>
        <span>Apache-2.0 - Original, dependency-free code - 66.51 KB Brotli base engine</span>
  ...
  head: function Head() {
    ...
    const description =
      ...
      'A dependency-free canvas charting engine with compact market profiles, five profile themes, 102 indicators, 51 drawing tools and on-chart trading, from a 66.51 KB base engine.';
    return (
      <>
