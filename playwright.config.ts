...
export default defineConfig({
  ...
  projects: [
    ...
    ...(['chromium', 'firefox', 'webkit'] as const).map(browserName => ({
      ...
      testMatch: /(?:widget-data-loading|drawing-future|drawing-catalog|widget-objects|navigation-wheel|widget-mobile|branding-watermark|crosshair-snap|workspace-storage|open-interest|alerts)\.spec\.ts/,
