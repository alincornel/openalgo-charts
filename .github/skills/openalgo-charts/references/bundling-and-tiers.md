...
|---|---|---|---|---|
| `openalgo-charts` | `dist/openalgo-charts.mjs` | engine, 13 chart types, indicator + chart-type registries, primitives, feeds, trading controller, shortcuts, TimeNavigator, `ReplayController`, comparison controller, settings schema, chart timezone | 92.94 kB / 93.5 kB | no |
...
|---|---|---|---|
| Base engine | `openalgo-charts.mjs` | 93.5 kB | 92.94 kB |
| Base + trade layer | base + `trade.mjs` | 101.5 kB | 100.95 kB |
...
| Widget terminal | base + `draw.mjs` + `indicators.mjs` + `widget.mjs` | 207.75 kB | 207.24 kB |
| Workspace tier | `workspace.mjs` | 6 kB | 5.52 kB |
| Everything | all nine bundles | 247.25 kB | 246.63 kB |
