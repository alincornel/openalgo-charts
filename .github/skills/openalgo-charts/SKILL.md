...
| `openalgo-charts/trade` | Order engine, state machine, order/position/bracket lines, DOM ladder | 81 KB with base |
...
Limits are the CI-enforced budgets in `.size-limit.json`. This reference targets 2.1.6.
