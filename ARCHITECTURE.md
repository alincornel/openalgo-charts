...
> **Current release: 2.4.5.** Nine independently loadable tiers include optional workspace documents and asynchronous catalog storage. Validated instrument metadata, widget translation and trading capability checks extend the existing public contracts. The 2.4.5 build measures **91.00 kB** base, **99.01 kB** base + trade and **243.96 kB** for all tiers (decimal Brotli sizes). Current measurements are in the README size budget; historical estimates and release measurements below remain labeled as such.
>
