...
> **Current release: 2.4.8.** Nine independently loadable tiers include optional workspace documents and asynchronous catalog storage. Alert threshold drafts preview separately from evaluation and commit once on release. The 2.4.8 build measures **92.91 kB** base, **100.92 kB** base + trade and **246.60 kB** for all tiers (decimal Brotli sizes). Current measurements are in the README size budget; historical estimates and release measurements below remain labeled as such.
>
